...
//                 <div className="flex items-center h-full px-2 text-yellow-950 text-sm">
//                         MY BOOKING
//                 </div>
//             </Link>
...
//                     <div className="flex items-center absolute left-2 h-full px-2 text-yellow-950 text-sm">
//                         SIGN-OUT
//                     </div>
//                 </Link>
//                  :
...
//                 <Link href="/register">
//                     <div className="flex items-center absolute left-24 h-full px-2 text-yellow-950 text-sm">
//                         REGISTER
//                     </div>
//                 </Link>
//         </div>
